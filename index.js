...
module.exports = function (input, flags) {
  if (isBroken()) {
    console.log(`
############################################################################
The version of node that you are running has issues with prompts on windows. 
This issue does not negatively effect our CLI, however you are encouraged to
